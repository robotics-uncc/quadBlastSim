...
totalMomentIdx = find(matches(out.logsout.getElementNames,'totalM'));
...
totalMx = squeeze(out.logsout{totalMomentIdx}.Values.Data(1,1,:));
totalMy = squeeze(out.logsout{totalMomentIdx}.Values.Data(1,2,:));
totalMz = squeeze(out.logsout{totalMomentIdx}.Values.Data(1,3,:));
